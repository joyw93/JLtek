<template>
  <div class="container">
    ...
    <v-text-field class="text-field" v-model="title" label="제목" variant="outlined"></v-text-field>
    <v-textarea class="text-field" v-model="content" label="내용" variant="outlined"></v-textarea>
    <div class="buttons">
